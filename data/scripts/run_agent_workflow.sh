...
main() {
    ...
    run_step "aggregate_quarterly_data" "Step 2: Aggregate quarterly data" "step_aggregate_quarterly_data"
    run_step "flag_high_risk_patients" "Step 3: Flag high-risk patients" "step_flag_high_risk_patients"
    run_step "hhvbp_model" "Step 4: Run HHVBP model" "step_hhvbp_model"
    run_step "star_rating_estimator" "Step 5: Calculate Star Rating estimates" "step_star_rating_estimator"
    run_step "git_push_outputs" "Step 6: Push outputs to GitHub" "step_git_push_outputs"
    run_step "log_completion" "Step 7: Log completion to history" "step_log_completion"
